...
// 參數：起始位置
int pos_home[]={ 90,90,90 };  // 起始位置
int pos[]={ 90,90,90 };  // 目前位置
...
void servo_goto()
{
  ...
  S1.write(180-pos[1]+adj[1]);  // for myPOSE Left Hand
...
void loop()
{
  int pos0[] = { 90,  0+90,   0+90 };
  int pos1[] = { 90, 60+90, -60+90 };
  int pos2[] = { 90,-60+90,  60+90 };
  int pos3[] = { 90,-60+90, -60+90 };
